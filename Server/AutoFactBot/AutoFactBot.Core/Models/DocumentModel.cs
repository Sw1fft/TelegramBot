namespace AutoFactBot.Core.Models
{
    public class DocumentModel
    {
        ...
        private DocumentModel(Guid id, string title, string carModel, string vinNumber,
            string engineNumber, string mileage, string owner, string countOwners,
            string year, string gearBox, string color, string countKeys, string interior)
        {
            Id              = id;
            Title           = title;
            CarModel        = carModel;
            ...
            string interior)
        {
            ...
            var document = new DocumentModel(id, title, carModel, vinNumber,
                engineNumber, mileage, owner, countOwners, year,
                gearBox, color, countKeys, interior);
